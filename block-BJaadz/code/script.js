...
allHrsArray.forEach((element) => element.style.background="antiquewhite");
...
// box16.nextSibling //#textassignedSlot: nullbaseURI: "http://127.0.0.1:5500/TA-JS-intro-to-dom-TJaaae/block-BJaadz/code/index.html"childNodes: NodeList []data: "↵        "firstChild: nullisConnected: truelastChild: nulllength: 9nextElementSibling: div.box.seventeennextSibling: div.box.seventeennodeName: "#text"nodeType: 3nodeValue: "↵        "ownerDocument: documentparentElement: div.archiveparentNode: div.archivepreviousElementSibling: div.box.sixteenpreviousSibling: div.box.sixteentextContent: "↵        "wholeText: "↵        "__proto__: Text
...
document.querySelector('.four').style.borderRadius="10px";
...
boxes.forEach((element,index) => {if((index +1) % 2!== 0){element.style.backgroundColor="aliceblue"}});
